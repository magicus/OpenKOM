...
public class ObjectNotFoundException  extends nu.rydin.kom.soap.client.UserException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://exceptions.kom.rydin.nu", "ObjectNotFoundException"));
    }
