...
public class EditorContext implements Context
{
    ...
    public void printCurrentConference() throws ObjectNotFoundException,
            UnexpectedException
    {
    ...
    public void executeScript(String script) throws IOException,
            InterruptedException, KOMException
    {
        m_underlying.executeScript(script);
    }

    public void executeScript(BufferedReader rdr) throws IOException,
            InterruptedException, KOMException
    {
    ...
    public void checkName(String name) throws DuplicateNameException,
            InvalidNameException, UnexpectedException
    {
