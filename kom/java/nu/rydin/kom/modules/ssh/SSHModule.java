...
public class SSHModule implements Module, Runnable
{
    ...
    //This is a straight copy from the J2SSH tutorial daemon.
    private static class DerivedInnerJ2SSHServer extends SshServer
    {
        public DerivedInnerJ2SSHServer() throws IOException
        {
            super();
        }
	...
	public void start(Map parameters)
	{
		...
		Logger.info(this, "OpenKOM SSH server is accepting connections at port " + (String)parameters.get("port"));	    
	}
